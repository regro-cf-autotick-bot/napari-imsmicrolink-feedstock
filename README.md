...
Once the `conda-forge` channel has been enabled, `napari-imsmicrolink` can be installed with:

```
conda install napari-imsmicrolink
```

It is possible to list all of the versions of `napari-imsmicrolink` available on your platform with:
